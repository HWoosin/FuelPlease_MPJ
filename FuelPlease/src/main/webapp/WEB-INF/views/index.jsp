...
<body>
	...
	<main id="main">
		...
		<section id="about" class="about">
			<div class="container" data-aos="fade-up">
				...
				<div class="row">
					<div class="col-lg-4">
						<img src="../../resources/img/profile-img.jpg" class="img-fluid" alt=""> <!--profile-img.jpg-->
					</div>
				...
				<div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-app">
						<div class="portfolio-wrap">
							<img src="../../resources/img/portfolio/portfolio-1.jpg" class="img-fluid" alt=""> <!--portfolio-1.jpg-->
							<div class="portfolio-info">
								<h4>App 1</h4>
								<p>App</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery" 
									class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a> <!--portfolio-1.jpg-->
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-web">
						<div class="portfolio-wrap">
							<img src="../../resources/img/portfolio/portfolio-2.jpg" class="img-fluid" alt=""> <!--portfoliio-2-->
							<div class="portfolio-info">
								<h4>Web 3</h4>
								<p>Web</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-app">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>App</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-3.jpg" data-gallery="portfolioGallery"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-card">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>Card</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-4.jpg" data-gallery="portfolioGallery"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-web">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>Web</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-5.jpg" data-gallery="portfolioGallery"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-app">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>App</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-6.jpg" data-gallery="portfolioGallery"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-card">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>Card</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-7.jpg" data-gallery="portfolioGallery"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-card">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>Card</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-8.jpg" data-gallery="portfolioGallery"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-web">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>Web</p>
								<div class="portfolio-links">
									<a href="../../resources/img/portfolio/portfolio-9.jpg" data-gallery="portfolioGallery"
										class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
									<a href="portfolio-details.html" class="portfolio-details-lightbox"
										data-glightbox="type: external" title="Portfolio Details"><i
											class="bx bx-link"></i></a>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<img src="../../resources/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt=""> <!--testimonials-2-->
								<h3>Sara Wilsson</h3>
								<h4>Designer</h4>
								<p>
									<i class="bx bxs-quote-alt-left quote-icon-left"></i>
	...
	<!-- Vendor JS Files -->
	<script src="../../resources/vendor/purecounter/purecounter_vanilla.js"></script> <!--purecounter_vanilla.js-->
	<script src="../../resources/vendor/aos/aos.js"></script> <!--aos.js-->
	<script src="../../resources/vendor/bootstrap/js/bootstrap.bundle.min.js"></script> <!--bootstrap.bundle.min-->
	<script src="../../resources/vendor/glightbox/js/glightbox.min.js"></script> <!--glightbox.min.js-->
	<script src="../../resources/vendor/isotope-layout/isotope.pkgd.min.js"></script> <!--isotope.pkgd.min.js-->
	<script src="../../resources/vendor/swiper/swiper-bundle.min.js"></script> <!--swiper-bundle.min.js-->
	<script src="../../resources/vendor/typed.js/typed.min.js"></script> <!--typed.min.js-->
	<script src="../../resources/vendor/waypoints/noframework.waypoints.js"></script> <!--noframework.waypoints.js-->
	<script src="../../resources/vendor/php-email-form/validate.js"></script> <!--validate.js-->
